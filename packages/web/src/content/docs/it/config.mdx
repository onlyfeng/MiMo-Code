...
- `reserved` - Buffer di compatibilità usato per convalidare il budget `max_context`; non viene sottratto dalla soglia di compattazione calcolata in base al rapporto.
