...
- `reserved` - Kompatibilitetsbuffer som brukes til å validere `max_context`-budsjettet; trekkes ikke fra komprimeringsterskelen som beregnes ut fra forholdstallet.
