...
> **Обновление 2026-09-08:** Ниже сохранён исторический анализ до интеграции компактных инструментов. Прямые shell/image-инструменты, исключения, изменяемый реестр и отсутствие передачи вложений заменены [текущим контрактом](../codex-compact-tools.md). Выбор harness унифицирован; разрешённые определения и видимые имена фиксируются отдельно, а exec передаёт вложения с установленными лимитами.
