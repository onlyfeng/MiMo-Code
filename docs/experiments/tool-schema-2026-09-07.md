...
- 设置 `MIMOCODE_DISABLE_PROJECT_CONFIG=true`、`MIMOCODE_DISABLE_DEFAULT_PLUGINS=true`、
  `MIMOCODE_DISABLE_AGENTS_SKILLS=true`、`MIMOCODE_DISABLE_CLAUDE_CODE=true`。
- 不设置品牌技能开关 `MIMOCODE_ENABLE_CLAUDE_CODE_SKILLS`、`MIMOCODE_ENABLE_CODEX_SKILLS`、
  `MIMOCODE_ENABLE_OPENCODE_SKILLS`。
